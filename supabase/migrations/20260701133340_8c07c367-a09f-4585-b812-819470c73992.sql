DROP FUNCTION IF EXISTS public.get_unidades_disponiveis(uuid);
...
GRANT EXECUTE ON FUNCTION public.get_unidades_disponiveis(uuid, uuid) TO anon, authenticated, service_role;