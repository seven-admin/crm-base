...
const projects = [
  {
    ...
    description: 'Complete overhaul of the company website with new branding guidelines and improved user experience across all pages.',
    meta: [
      { icon: Clock, text: 'Due Mar 15' },
      { icon: Users, text: '8 members' },
    ],
  },
  {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-4">
        <p style={{ fontSize: 15, fontWeight: 600, color: '#1E293B' }}>Projects</p>
          ...
          <div key={i}>
            ...
            <div className="flex items-start gap-3 py-4" style={{ cursor: 'pointer' }}>
              ...
              <div
                ...
                style={{ width: 48, height: 48, borderRadius: 14, background: p.iconBg }}
              >
