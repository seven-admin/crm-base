...
export function TestHeroCard() {
  return (
    <div
      ...
      <p style={{ fontSize: 14, color: '#94A3B8', lineHeight: 1.5, maxWidth: 360 }}>Acompanhe os indicadores de desempenho e metas comerciais. Compare resultados semanais com períodos anteriores.
